...
public class Op_Cuentas_vs_Cuentas_CTCMod extends BasePage {
    ...
    private final String cliente = "//a[contains(@title,'QtkQQ FRROz hzqCn zIgft')]";
    ...
    // Ingreso de Monedas, Montos y Tipos de Cambios
    ...
    private final String tipoCambio = "(//input[@type='text'])[3]";
    
    //Atributos Medios de Pago Ingreso
    private final String medioPagoIngreso = "//button[contains(@name,'progress')]";
    private final String selectPagoIngreso = "//span[contains(@title,'Cuenta Corriente MN - CLP -  CCT 00006065724')]";
    private final String imputMonto = "(//input[@type='text'])[5]";
    private final String selectPagoIngreso2 = "//span[contains(@title,'Efectivo caja M/N - CLP -  000000000000')]";
    ...
    private final String selectPagoEgreso2 = "(//span[contains(.,'Cuenta Corriente MX - USD -  ECC 35108049055')])[1]";
    ...
    //Variables ingreso Monto Origen y Tipo de Cambio
    private final String monto = "20000";
    private final String cambio = "956,00";
    //Variables ingreso Monto de Pago ingreso
    private final String montoCCMN = "10000";
    private final String montoCaja = "10000";
    //Variables ingreso Monto Egreso
    private final String montoCCMX= "10,92";
    private final String montoCajaMX = "10"; 

    private final String observacion = "Prueba en USD";

    public Op_Cuentas_vs_Cuentas_CTCMod() {
        super(driver);
    }
